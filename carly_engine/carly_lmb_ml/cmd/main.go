...
var name = "LocalTest-" + pkg.CARLY_ENGINE_LMB_ML.Name

func main() {
	_ = os.Setenv("AWS_REGION", pkg.AWSDeployRegion)
	_ = os.Setenv(pkg.EnvSpiderName, pkg.CARLY_ENGINE_LMB_ML.Name)
	...
	spider_ml.Handler(pkg.CarlyEngineLmbMLEvent{
...
const testArticle = `
The U.S. is willing to sit down with Iran “tomorrow” and jointly agree to full compliance with the nuclear accord they and five other world powers signed in 2015, according to a senior Biden administration official.
